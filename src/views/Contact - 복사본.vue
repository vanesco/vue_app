    ...
    <transition name="fade">
      <modal-popup v-if="isShow">
        <form id="send-form">
          ...
          <input type="text" name="email" v-model="email" placeholder="보내는이 이메일" />
          <input type="text" name="title" v-model="title" placeholder="제목" />
          <textarea name="message" placeholder="내용" v-model="message"></textarea>
...
export default {
  ...
  methods: {
    ...
    //       $(event.target).val("이메일 주소를 확인하세요.");
    //       return false;
    //     }
    //   });
    // }
